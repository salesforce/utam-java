...
import static selenium.element.LocatorUtilities.QUERY_FILTER_WRAPPER;
import static selenium.element.Selector.Type.CSS;
import static selenium.element.ShadowBoundary.EXPAND_SHADOW_ROOT;
...
public abstract class LocatorNodeImpl implements LocatorNode {
  ...
  static class Css extends LocatorNodeImpl {
    ...
    Css(String selector, String selectorString, Filter filter, Transformer transformer) {
      super(
          new selenium.element.Web.SelectorImpl(CSS, selector),
          selectorString,
          transformer,
          filter);
    }
  ...
  public static final class Web extends LocatorNodeImpl {
    ...
    static final Selector MOCK_SELECTOR = new selenium.element.Web.SelectorImpl(CSS, "WebElement");
