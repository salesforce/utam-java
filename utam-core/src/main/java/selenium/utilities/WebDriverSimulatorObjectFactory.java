...
import selenium.utilities.WebDriverSimulator.WebElementInfo;

/**
 * Describes the interface used to create the driver and element implementations for use
 * with the WebDriverSimulator
 * 
 * @author james.evans
 *
 */
public abstract class WebDriverSimulatorObjectFactory {
   ...
   */
  protected abstract void setElementAttribute(WebElement element, String attributeName, String attributeValue);
