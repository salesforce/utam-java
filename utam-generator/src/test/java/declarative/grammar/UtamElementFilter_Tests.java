...
import static declarative.grammar.DeserializerUtilities.getObjectFromFile;
import static declarative.grammar.TestUtilities.TEST_URI;
import static declarative.grammar.TestUtilities.getTestTranslationContext;
import static declarative.grammar.UtamElement.ERR_ELEMENT_FILTER_NEEDS_LIST;
import static declarative.grammar.UtamElementFilter.ERR_INCORRECT_MATCHER_FOR_METHOD;
import static declarative.helpers.TypeUtilities.Element.actionable;
import static declarative.helpers.TypeUtilities.Element.editable;
...
public class UtamElementFilter_Tests {
  ...
  public void testDuplicateArgsNames() {
    UtamElement object = getObjectFromFile("basicFilterDuplicateArgs", UtamElement.class);
    UtamElement.Traversal element = object.getAbstraction();
    UtamError e =
        expectThrows(UtamError.class, () -> element.testRootTraverse(getTestTranslationContext()));
  ...
  public void testCustomNestedFilterFindFirst() {
    UtamElement object = getObjectFromFile("customFilterNested", UtamElement.class);
