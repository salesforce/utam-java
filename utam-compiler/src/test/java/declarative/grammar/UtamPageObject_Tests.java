...
import declarative.translator.StringValueProfileConfig;
...
import static declarative.grammar.UtamPageObject.*;
import static declarative.grammar.UtamProfile_Tests.PROFILE_KEY;
import static declarative.grammar.UtamProfile_Tests.PROFILE_VALUE;
import static declarative.grammar.UtamSelector_Tests.SELECTOR_STRING;
import static declarative.helpers.ElementContext.ROOT_ELEMENT_NAME;
import static declarative.helpers.TypeUtilities.PAGE_OBJECT;
import static declarative.helpers.TypeUtilities.ROOT_PAGE_OBJECT;
