 ...
 * This context object can be used by utilities authors when they need to interact with the current PO instance.
 * For instance if they need to do some actions or implement some custom logic around basic/custom elements in the current page.
 *
